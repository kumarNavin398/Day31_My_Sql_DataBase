...
insert into addressBook (firstname,lastname,address,city,state,zip,phone,email) values ('Krunali','Lole','Manewada','Nagpur',
'Maharashtra','440024','9561272972','krunali@gmail.com' ),('Deepika','Ganorkar','Wadi','Nagpur','Maharashtra','440021','9422101502','deepikag@gmail.com')
,('Rohit','Sharma','Dattawadi','Nagpur','Maharashtra','440006','8626001501','rohit@gmail.com');
select *from addressBook;

update addressBook set phone = '917232888' where firstname = 'Navin';
...
update addressBook set bookname='Book1' where firstname = 'Navin';
update addressBook set bookname='Book2' where firstname = 'Deepika';
update addressBook set bookname='Book3' where firstname = 'Rohit';
update addressBook set booktype='Family' where firstname = 'Krunali';
